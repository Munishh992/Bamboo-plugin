...
public final class Messages {
    ...
    public static final String AUTO_REPORT_ENABLED = "Auto Report Enabled = %1$s";
    ...
    public static final String BAMBOO_WORKSPACE_VARIABLE = "WORKSPACE: %1$s";
    ...
    public static final String PLUGIN_SUCCESSFUL_FINISH = "Leapwork for Bamboo  plugin  successfully finished!";
    public static final String PLUGIN_ERROR_FINISH = "Leapwork for Bamboo plugin finished with errors!";
